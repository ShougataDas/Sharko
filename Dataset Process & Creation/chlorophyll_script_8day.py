...
DATA_DIR = "chlorophyll_data_8day"
...
# ==============================================================================
# STEP 2: DOWNLOAD FUNCTION (UNCHANGED)
# ==============================================================================
def download_nc_file(start_date, retries=3):
    ...
    # 3. Construct the correct filename
    fname = f"AQUA_MODIS.{start_date_str}_{end_date_str}.L3m.8D.CHL.chlor_a.4km.nc"
...
# --- NEW: Robustly generate the list of start dates for each 8-day period ---
